    ...
    <div className="space-y-4">
      <div className="sticky top-0 z-10 rounded-2xl border border-slate-100 bg-white/95 px-4 py-3 shadow-[0_8px_30px_rgba(15,23,42,0.06)] backdrop-blur">
        <div className="flex flex-wrap items-center justify-between gap-3">
          ...
          <div className="inline-flex items-center gap-2 rounded-full bg-rose-50 px-3 py-1.5 text-[0.75rem] font-semibold text-rose-600">
      ...
      <div className="rounded-2xl border border-rose-100 bg-rose-50/30 p-4">
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div className="flex items-center gap-2">
            ...
            <div>
              {/* 0.65rem → 0.75rem */}
              <p className="text-[0.75rem] tracking-[0.18em] text-rose-400 uppercase">
                Ошибки при импорте
              </p>
              {/* text-xs → text-sm */}
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <button
              ...
              className="inline-flex items-center justify-center gap-2 rounded-lg border border-slate-200 bg-slate-900 px-4 py-2.5 text-sm font-semibold text-white shadow-sm transition hover:bg-slate-800 active:bg-slate-700"
            >
              Скачать .txt
            </button>
          </div>
        ...
        >
          <ul
            className="relative text-base text-slate-600"
