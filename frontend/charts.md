...
const data = [
  { month: 'JAN', value: 2.3, label: 250000 },
  { month: 'FEB', value: 4.5, label: 250000 },
  { month: 'MAR', value: 3.8 },
  { month: 'APR', value: 3.5, label: 250000 },
  { month: 'MAY', value: 6.7, label: 250000 },
  { month: 'JUN', value: 5.2 },
  { month: 'JUL', value: 3.0, label: 250000 },
  { month: 'AUG', value: 3.2, label: 250000 },
  { month: 'SEP', value: 4.0 },
  { month: 'OCT', value: 7.8, label: 250000 },
  { month: 'NOV', value: 6.1 },
  { month: 'DEC', value: 4.7 },
];
...
const CustomTooltip = ({ active, payload, label }: any) => {
  if (active && payload && payload.length) {
    return (
      <div className="rounded-xl bg-white px-3 py-2 shadow-md border border-gray-200 font-poppins">
...
const LineChart: React.FC = () => {
  return (
    <main className="p-6 w-full">
      <section className="w-full bg-white p-6 rounded-3xl flex justify-start">
